...
puts "La suma de a y b es "; puts a.suma(b) 
puts "La resta de a y b es:"; puts a.resta(b) 
puts "La multiplicacion de a y b es:"; puts a.mult(b) 
puts "La division de a y b es:"; puts a.div(b) 
